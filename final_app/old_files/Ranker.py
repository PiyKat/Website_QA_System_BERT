...
class DocumentRanker():
    ...
    def __init__(self, query, folderPath):
        ...
        queryObj = queryProcess(query)
        self.queryList = queryObj.returnDRQuery()
...
class PassageRanker():
    ...
    def __init__(self, query, topDocumentContent):
        ...
        queryObj = queryProcess(query)
        self.queryList,self.nounList = queryObj.returnPRQuery()
    ...
    def returnTopPassages(self, k=10):
        ...
        #for documents in self.topDocumentContent:
        #paragraphScores = self.returnParagraphScores(passageBM25Model, self.queryList)
