...
class DocumentRanker():
    ...
    def __init__(self, query, folderPath):
        ...
        x = [x[1] for x in self.folderDocumentContent]
        print(x[1:5])
    ...
    def getNouns(self):
        ...
        print("noun and adjective list : ", nounList)        
        return nounList
    ...
    def rankDocuments(self):
        ...
        scores = self.bm25Model.get_scores(tokQuery)
...
class PassageRanker():
    ...
    def __init__(self, query, topDocumentContent):
        ...
        print(self.topDocumentContent)
        
        for files in self.topDocumentContent:
            if files[1] == "mbs.asp.txt":
                print(files[2])
        #self.BM25Model = self.createBM25Model()
    ...
    '''            
    def returnTopDocumentPassages(self):
